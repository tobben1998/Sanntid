...
void array_reserve(Array* a, long capacityfac){
    long* b= malloc(sizeof(long)*a->capacity*capacityfac);
    memcpy(b, a->data, a->capacity*sizeof(long));
    array_destroy(*a);
    a->data=b;
    a->capacity=a->capacity*capacityfac;
